...
## 2026-06
- **Perpetual futures design published** — architecture for linear, USDT-margined perps on the in-house engine: same matching core with a position-and-margin settlement branch, oracle-anchored [mark price](Perp-Mark-Price.md), [funding](Perp-Funding.md), [liquidation & insurance fund](Perp-Liquidation.md), a [risk engine](Perp-Risk-Engine.md) (leverage tiers, cross-margin, auto-deleveraging), and [perp bots](Perp-Bots.md) (long/short/neutral grid, funding-rate arbitrage) with per-bot account isolation. Includes an [insurance-fund case study](Perp-Insurance-Fund-Case-Study.md) and a broader [adversarial-lessons survey](Perp-Adversarial-Lessons.md) deriving hardening principles from public 2024–2026 perp-DEX incidents (vault drains, griefing/externally-hedged attacks, ADL weaponization, oracle corporate-action crashes, market-wide cascades). See [Perpetual Futures](Perpetuals.md). *(Design — not yet shipped.)*
